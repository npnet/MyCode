...
/* Network Related Messages */
	...
	} mmi_nw_cfun_state_req_ind_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint8	cfun_state;
...
/* Engineer Mode */
	...
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint32	mode;
	} mmi_em_set_essp_req_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_bool	result;
	} mmi_em_set_essp_rsp_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint32	mode;
	} mmi_em_get_essp_rsp_struct;	
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint8	action;
...
/* A-GPS Control Plane LCS Service */
	...
	{
		LOCAL_PARA_HDR
		kal_uint16	string[52];
	} mmi_eq_at_quick_input_ind_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint8	port;
...
/* Below are NOT script generated code struct */
	...
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_uint8	setting;
		kal_uint8	new_rat; /* l4c_rat_enum */
	} mmi_l4c_set_sim_capability_req_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_bool	result;
	} mmi_l4c_set_sim_capability_rsp_struct;
	typedef struct
	{
		LOCAL_PARA_HDR
		kal_bool	result;
		kal_uint8	setting;
	} mmi_l4c_get_sim_capability_rsp_struct;
