...
#define  NVRAM_EF_CAT_TIMESTAMP_LID_VERNO                    "000"
...
#define  NVRAM_EF_L1_RFSPECIALCOEF_LID_VERNO                 "005"
...
#define NVRAM_EF_NET_PAR_LID_VERNO                           "007"
...
#define NVRAM_EF_UMTS_USIME_RRC_DYNAMIC_CAP_LID_VERNO        "016"
...
#define NVRAM_EF_MYBCCH_SETTING_DATA_LID_VERNO              "000"
...
/* UEM*/
#define NVRAM_EF_CUST_HW_LEVEL_TBL_LID_VERNO            "003"
...
#define NVRAM_EF_RAC_PREFERENCE_LID_VERNO               "005"
...
typedef struct 
{
    kal_uint8 mybcch_setting[6];
} nvram_ef_mybcch_setting_struct;
...
/* under construction !*/
    ...
    kal_uint32 BacklightLevel[PWM_MAX_BACKLIGHT_LEVEL][2];
#endif
...
typedef tcm_ps_qos_profile_struct   nvram_ef_abm_ps_qos_profile_struct;
...
/***********************************************************************
  ...
  ***********************************************************************/
        ...
        LID_BIT VER_LID(NVRAM_EF_SML_LID)
            ...
            {
                magic_head:"magic number head"
                {
                    magic_head:32 "magic number"
                    {
                    };
                };

                cat:"SIM-ME Lock status"
                {
                };
                cat[0].state {
					state:8 "Network Personalization lock state"
                    {
						0x0: "NULL";
						0x1: "LOCK";
						0x2: "UNLOCK";
                ...
                cat[0].retry_count {
                    retry_count:8 "Network Personalization max retry count"
                    {
					};
                };
                cat[0].autolock_count {
                    autolock_count:8 "Network Personalization auto lock count"
                    {
                    };
                };
                cat[0].num {
                    num:8 "Network Personalization number of lock"
                    {
                    };
                };
                
                cat[1].state {
					state:8 "Network Subset Personalization lock state"
                    {
						0x0: "NULL";
						0x1: "LOCK";
						0x2: "UNLOCK";
                ...
                cat[1].retry_count {
                    retry_count:8 "Network Subset Personalization max retry count"
                    {
					};
                };
                cat[1].autolock_count {
                    autolock_count:8 "Network Subset Personalization auto lock count"
                    {
                    };
                };
                cat[1].num {
                    num:8 "Network Subset Personalization number of lock"
                    {
                    };
                };
                
                cat[2].state {
                    state:8 "SP Personalization lock state"
                    {
                        0x0: "NULL";
                        0x1: "LOCK";
                        0x2: "UNLOCK";
                ...
                cat[2].retry_count {
                    retry_count:8 "SP Personalization max retry count"
                    {
					};
                };

                cat[2].autolock_count {
                    autolock_count:8 "SP Personalization auto lock count"
                    {
                    };
                };
                cat[2].num {
                    num:8 "SP Personalization number of lock"
                    {
                    };
                };
                
                cat[3].state {
                    state:8 "Corporate Personalization lock state"
                    {
                        0x0: "NULL";
                        0x1: "LOCK";
                        0x2: "UNLOCK";
                ...
                cat[3].retry_count {
                    retry_count:8 "Corporate Personalization max retry count"
                    {
					};
                };

                cat[3].autolock_count {
                    autolock_count:8 "Corporate Personalization auto lock count"
                    {
                    };
                };
                cat[3].num {
                    num:8 "Corporate Personalization number of lock"
                    {
                    };
                };

                cat[4].state {
                    state:8 "SIM Personalization lock state"
                    {
                        0x0: "NULL";
                        0x1: "LOCK";
                        0x2: "UNLOCK";
                ...
                cat[4].retry_count {
                    retry_count:8 "SIM Personalization max retry count"
                    {
					};
                };

                cat[4].autolock_count {
                    autolock_count:8 "SIM Personalization auto lock count"
                    {
                    };
                };
                cat[4].num {
                    num:8 "SIM Personalization number of lock"
                    {
                    };
                };

                cat[5].state {
                    state:8 "NS-SP Personalization lock state"
                    {
                        0x0: "NULL";
                        0x1: "LOCK";
                        0x2: "UNLOCK";
                ...
                cat[5].retry_count {
                    retry_count:8 "NS-SP Personalization max retry count"
                    {
					};
                };

                cat[5].autolock_count {
                    autolock_count:8 "NS-SP Personalization auto lock count"
                    {
                    };
                };
                cat[5].num {
                    num:8 "NS-SP Personalization number of lock"
                    {
                    };
                };

                cat[6].state {
                    state:8 "SIM-C Personalization lock state"
                    {
                        0x0: "NULL";
                        0x1: "LOCK";
                        0x2: "UNLOCK";
                ...
                cat[6].retry_count {
                    retry_count:8 "SIM-C Personalization max retry count"
                    {
					};
                };

                cat[6].autolock_count {
                    autolock_count:8 "SIM-C Personalization auto lock count"
                    {
                    };
                };
                cat[6].num {
                    num:8 "SIM-C Personalization number of lock"
                    {
                    };
                };
                ...
                key[0].state {
                    state:8 "Network Personalization key state" 
                    {
                        0x00: "EMPTY";
                        0x01: "SET";
                    };
                ...
                key[0].key {
                    key:8 "Network Personalization control key"
                    {
                    };
                };
                key[1].state {
                    state:8 "Network Subset Personalization key state"
                    {
                        0x0: "EMPTY";
                        0x1: "SET";
                    };
                ...
                key[1].key {
                    key:8 "Network Subset Personalization control key"
                    {
                    };
                };
                key[2].state {
                    state:8 "SP Personalization key state"
                    {
                        0x0: "EMPTY";
                        0x1: "SET";
                    };
                ...
                key[2].key {
                    key:8 "SP Personalization control key"
                    {
                    };
                };
                key[3].state {
                    state:8 "Corporate Personalization key state"
                    {
                        0x0: "EMPTY";
                        0x1: "SET";
                    };
                ...
                key[3].key {
                    key:8 "Corporate Personalization control key"
                    {
                    };
                };
                key[4].state {
                    state:8 "SIM Personalization key state"
                    {
                        0x0: "EMPTY";
                        0x1: "SET";
                    };
                ...
                key[4].key {
                    key:8 "SIM Personalization control key"
                    {
                    };
                };
                key[5].state {
                    state:8 "NS-SP Personalization key state"
                    {
                        0x0: "EMPTY";
                        0x1: "SET";
                    };
                ...
                key[5].key {
                    key:8 "NS-SP Personalization control key"
                    {
                    };
                };
                key[6].state {
                    state:8 "SIM-C Personalization key state"
                    {
                        0x0: "EMPTY";
                        0x1: "SET";
                    };
                ...
                key[6].key {
                    key:8 "SIM-C Personalization control key"
                    {
                    };
                };

                code_cat_n: "Network Personalization Code"
                {
                };

                code_cat_ns:"Network Subset Personalization Code"
                {
                };
               
                code_cat_sp:"Service Provider Personalization Code"
                {
                };

                code_cat_c:"Corporate Personalization Code"
                {
                };

                code_cat_sim:"SIM Personalization Code"
                {
                };
                
                code_cat_ns_sp:"NS-SP Personalization Code"
                {
                };
                
                code_cat_sim_c:"SIM-C Personalization Code"
                {
                };
                
                range_cat_ns:"Network Subset Personalization code range"
                {
                };
                magic_tail:"magic number tail"
                {
                    magic_tail:32 "magic number"
                    {
                    };
                };
            };
...
//#if  defined(__BTMODULE_MT6612__) || defined(__BTMODULE_MT6616__) || defined(__BTMODULE_MT6622__) || defined(__BTMODULE_MT6626__) ||defined(__BTMODULE_MT6236__) || defined(__BTMODULE_MT6256__) || defined(__BTMODULE_MT6276__) || defined(__BTMODULE_MT6255__) || defined(__BTMODULE_MT6250__) || defined (__BTMODULE_GSM_BT_SOC__)
...
/***********************************************************************
  ***  This is a nvram data item bit level description for meta tools nvram editor
  ***
  ***  Logical Data Item ID : NVRAM_EF_MYBCCH_SETTING_DATA_LID
  ***
  ***  Module:
  ***
  ***  Description:
  ***
  ***  Maintainer: Roland Li
  ***
  ***********************************************************************/
#ifdef __ENABLE_MYBCCH__
     LID_BIT VER_LID(NVRAM_EF_MYBCCH_SETTING_DATA_LID)
     nvram_ef_mybcch_setting_struct *NVRAM_EF_MYBCCH_SETTING_DATA_TOTAL
     {
         mybcch_setting:"user locked bcch"
         {
         };
     };
#endif /* __ENABLE_MYBCCH__ */
...
#ifdef __FDD_RF_CUSTOM_TOOL_SUPPORT__
...
/***********************************************************************
  ***  This is a nvram data item bit level description for meta tools nvram editor
  ***
  ***  Logical Data Item ID : NVRAM_EF_ABM_PS_QOS_PROFILE_LID
  ***
  ***  Module:
  ***
  ***  Description:
  ***
  ***  Maintainer: Leona Chou
  ***
  ***********************************************************************/
     ...
     nvram_ef_abm_ps_qos_profile_struct *NVRAM_EF_ABM_PS_QOS_PROFILE_TOTAL
     {
        ...
        req_qos.qos_length: "Length of QoS IEI"
        {
            qos_length:8 "Length of QoS IEI"
            {
            } ;
        } ;

        req_qos.unused1: "Unused Bit"
        {
            unused1:8 "Unused Bit"
            {
            } ;
        } ;
        ...
        req_qos.reliability_class: "Reliability class"
        {
            reliability_class:8 "Reliability class"
            {
                0x00: "Subscribed" ;
                0x01: "Interpreted as 010" ;
                0x02: "Unacknowledged GTP; Acknowledged LLC and RLC, Protected data " ;
                0x03: "Unacknowledged GTP and LLC; Acknowledged RLC, Protected data" ;
                0x04: "Unacknowledged GTP, LLC, and RLC, Protected data" ;
                0x05: "Unacknowledged GTP, LLC, and RLC, Unprotected data" ;
                0x06: "Unacknowledged GTP and LLC; Acknowledged RLC, Protected data" ;
                0x07: "Reserved" ;
            } ;
        };
        ...
        req_qos.peak_throughput: "Peak throughput"
        {
            peak_throughput:8 "Peak throughput"
            {

                0x00: "Subscribed" ;
                0x01: "Up to 1000 octet/s" ;
                0x02: "Up to 2000 octet/s" ;
                0x03: "Up to 4000 octet/s" ;
                0x04: "Up to 8000 octet/s" ;
                0x05: "Up to 16000 octet/s" ;
                0x06: "Up to 32000 octet/s" ;
                0x07: "Up to 64000 octet/s" ;
                0x08: "Up to 128000 octet/s" ;
                0x09: "Up to 256000 octet/s" ;
            } ;
        } ;

        req_qos.unused2: "Unused Bit"
        {
            unused2:8 "Unused Bit"
            {
            } ;
        } ;
        ...
        req_qos.precedence_class: "Precedence class"
        {
            precedence_class:8 "Precedence class"
            {
                0x00: "Subscribed" ;
                0x01: "High priority" ;
        ...
        req_qos.unused3: "Unused Bit"
        {
            unused3:8 "Unused Bit"
            {
            } ;
        } ;

        req_qos.mean_throughput: "mean_throughput"
        {
            mean_throughput:8 "mean_throughput"
            {
                0x00: "Subscribed" ;
                0x01: "100 octet/h" ;
                0x02: "200 octet/h" ;
                ...
                0x08: "20 000 octet/h" ;
                0x09: "50 000 octet/h" ;
                0x10: "100 000 octet/h" ;
                0x11: "200 000 octet/h" ;
                0x12: "500 000 octet/h" ;
                0x13: "1 000 000 octet/h" ;
                0x14: "2 000 000 octet/h" ;
                0x15: "5 000 000 octet/h" ;
                0x16: "10 000 000 octet/h" ;
                0x17: "20 000 000 octet/h" ;
                0x18: "50 000 000 octet/h" ;
                0x1E: "Reserved" ;
                0x1F: "Best effort" ;
            } ;
        } ;
        ...
        req_qos.delivery_order: "Delivery order"
        {
            delivery_order:8 "Delivery order"
            {
                0x00: "Subscribed" ;
        ...
        req_qos.delivery_of_err_sdu: "Delivery of erroneous SDUs"
        {
            delivery_of_err_sdu:8 "Delivery of erroneous SDUs"
            {
                0x00: "Subscribed" ;
                0x01: "No detect ('-')" ;
        ...
        req_qos.max_sdu_size: "Maximum SDU size (0x00: Subscribed, 0xFF: Reserved, 0x97: 1502 octets, 0x98: 1510 octets, 0x99: 1520 octets)"
        {
            max_sdu_size:8 "Maximum SDU size (0x00: Subscribed, 0xFF: Reserved, 0x97: 1502 octets, 0x98: 1510 octets, 0x99: 1520 octets)"
            {
                #if 0
/* under construction !*/
/* under construction !*/
...
/* under construction !*/
        ...
        req_qos.max_bitrate_up_lnk: "Maximum bit rate for uplink (0x00: Subscribed, 0xFE: 8640kbps, 0xFF: 0kbps)"
        {
            max_bitrate_up_lnk:8 "Maximum bit rate for uplink (0x00: Subscribed, 0xFE: 8640kbps, 0xFF: 0kbps)"
            {
                #if 0
/* under construction !*/
/* under construction !*/
/* under construction !*/
        ...
        req_qos.max_bitrate_down_lnk: "Maximum bit rate for downlink (0x00: Subscribed, 0xFE: 8640kbps, 0xFF: 0kbps)"
        {
            max_bitrate_down_lnk:8 "Maximum bit rate for downlink (0x00: Subscribed, 0xFE: 8640kbps, 0xFF: 0kbps)"
            {
                #if 0
/* under construction !*/
/* under construction !*/
/* under construction !*/
        ...
        req_qos.residual_bit_err_rate: "Residual Bit Error Rate (BER)"
        {
            residual_bit_err_rate:8 "Residual Bit Error Rate (BER)"
            {
                0x00: "Subscribed" ;
                0x01: "5*10^-2" ;
                0x02: "1*10^-2" ;
        ...
        req_qos.sdu_err_ratio: "SDU error ratio"
        {
            sdu_err_ratio:8 "SDU error ratio"
            {
                0x00: "Subscribed" ;
                0x01: "1*10^-2" ;
                0x02: "7*10^-3" ;
        ...
        req_qos.transfer_delay: "Transfer delay (0x00: Subscribed, 0xFF: Reserved)"
        {
            transfer_delay:8 "Transfer delay (0x00: Subscribed, 0xFF: Reserved)"
            {
                #if 0
/* under construction !*/
/* under construction !*/
        ...
        req_qos.traffic_hndl_priority: "Traffic handling priority"
        {
            traffic_hndl_priority:8 "Traffic handling priority"
            {
                0x00: "Subscribed" ;
        ...
        req_qos.guarntd_bit_rate_up_lnk: "Guaranteed bit rate for uplink (0x00: Subscribed, 0xFE: 8640kbps, 0xFF: 0kbps)"
        {
            guarntd_bit_rate_up_lnk:8 "Guaranteed bit rate for uplink (0x00: Subscribed, 0xFE: 8640kbps, 0xFF: 0kbps)"
            {
                #if 0
/* under construction !*/
/* under construction !*/
/* under construction !*/
        ...
        req_qos.guarntd_bit_rate_down_lnk: "Guaranteed bit rate for downlink (0x00: Subscribed, 0xFE: 8640kbps, 0xFF: 0kbps)"
        {
            guarntd_bit_rate_down_lnk:8 "Guaranteed bit rate for downlink (0x00: Subscribed, 0xFE: 8640kbps, 0xFF: 0kbps)"
            {
                #if 0
/* under construction !*/
/* under construction !*/
/* under construction !*/
        ...
        req_qos.unused4: "Unused Bit"
        {
            unused4:8 "Unused Bit"
            {
            } ;
        };
        ...
        req_qos.signalling_indication: "Signalling Indication"
        {
            signalling_indication:8 "Signalling Indication"
            {
                0x00: "Not optimised for signalling traffic" ;
                0x01: "Optimised for signalling traffic" ;
            } ;
        } ;

        req_qos.source_statistics_descriptor: "Source Statistics Descriptor"
        {
            source_statistics_descriptor:8 "Source Statistics Descriptor"
            {
                0x00: "unknown" ;
                0x01: "speech" ;
            } ;
        ...
        req_qos.ext_max_bitrate_down_lnk: "Maximum bit rate for downlink (extended) (0x00: Use the value indicated by the Maximum bit rate for downlink (octet 9))"
        {
            ext_max_bitrate_down_lnk:8 "Maximum bit rate for downlink (extended) (0x00: Use the value indicated by the Maximum bit rate for downlink (octet 9))"
            {
                // 0x00: "Use the value indicated by the Maximum bit rate for downlink (octet 9)" ;
            } ;
        } ;

        req_qos.ext_guarntd_bit_rate_down_lnk: "Guaranteed bit rate for downlink (extended) (0x00: Use the value indicated by the Guaranteed bit rate for downlink in (octet 13))"
        {
            ext_guarntd_bit_rate_down_lnk:8 "Guaranteed bit rate for downlink (extended) (0x00: Use the value indicated by the Guaranteed bit rate for downlink in (octet 13))"
            {
                // 0x00: "Use the value indicated by the Guaranteed bit rate for downlink in (octet 13)" ;
            } ;
        } ;

        req_qos.ext_max_bitrate_up_lnk: "Maximum bit rate for uplink (extended) (0x00: Use the value indicated by the Maximum bit rate for uplink (octet 8))"
        {
            ext_max_bitrate_up_lnk:8 "Maximum bit rate for uplink (extended) (0x00: Use the value indicated by the Maximum bit rate for uplink (octet 8))"
            {
                // 0x00: "Use the value indicated by the Maximum bit rate for uplink (octet 8)" ;
            } ;
        } ;

        req_qos.ext_guarntd_bit_rate_up_lnk: "Guaranteed bit rate for uplink (extended) (0x00: Use the value indicated by the Guaranteed bit rate for downlink (octet 12))"
        {
            ext_guarntd_bit_rate_up_lnk:8 "Guaranteed bit rate for uplink (extended) (0x00: Use the value indicated by the Guaranteed bit rate for downlink (octet 12))"
            {
                // 0x00: "Use the value indicated by the Guaranteed bit rate for downlink (octet 12)" ;
            } ;
        } ;
        ...
        min_qos.qos_length: "Length of QoS IEI"
        {
            qos_length:8 "Length of QoS IEI"
            {
            } ;
        ...
        min_qos.mean_throughput: "mean_throughput"
        {
            mean_throughput:8 "mean_throughput"
            {
                0x00: "Subscribed" ;
        ...
        min_qos.delivery_of_err_sdu: "Delivery of erroneous SDUs"
        {
            delivery_of_err_sdu:8 "Delivery of erroneous SDUs"
            {
                0x00: "Subscribed" ;
        ...
        min_qos.max_sdu_size: "Maximum SDU size (0x00: Subscribed, 0xFF: Reserved, 0x97: 1502 octets, 0x98: 1510 octets, 0x99: 1520 octets)"
        {
            max_sdu_size:8 "Maximum SDU size (0x00: Subscribed, 0xFF: Reserved, 0x97: 1502 octets, 0x98: 1510 octets, 0x99: 1520 octets)"
            {
                #if 0
...
/* under construction !*/
        ...
        min_qos.max_bitrate_up_lnk: "Maximum bit rate for uplink (0x00: Subscribed, 0xFE: 8640kbps, 0xFF: 0kbps)"
        {
            max_bitrate_up_lnk:8 "Maximum bit rate for uplink (0x00: Subscribed, 0xFE: 8640kbps, 0xFF: 0kbps)"
            {
                #if 0
...
/* under construction !*/
        ...
        min_qos.max_bitrate_down_lnk: "Maximum bit rate for downlink (0x00: Subscribed, 0xFE: 8640kbps, 0xFF: 0kbps)"
        {
            max_bitrate_down_lnk:8 "Maximum bit rate for downlink (0x00: Subscribed, 0xFE: 8640kbps, 0xFF: 0kbps)"
            {
                #if 0
...
/* under construction !*/
        ...
        min_qos.residual_bit_err_rate: "Residual Bit Error Rate (BER)"
        {
            residual_bit_err_rate:8 "Residual Bit Error Rate (BER)"
            {
                0x00: "Subscribed" ;
        ...
        min_qos.transfer_delay: "Transfer delay (0x00: Subscribed, 0xFF: Reserved)"
        {
            transfer_delay:8 "Transfer delay (0x00: Subscribed, 0xFF: Reserved)"
            {
                #if 0
...
/* under construction !*/
        ...
        min_qos.traffic_hndl_priority: "Traffic handling priority"
        {
            traffic_hndl_priority:8 "Traffic handling priority"
            {
                0x00: "Subscribed" ;
        ...
        min_qos.guarntd_bit_rate_up_lnk: "Guaranteed bit rate for uplink (0x00: Subscribed, 0xFE: 8640kbps, 0xFF: 0kbps)"
        {
            guarntd_bit_rate_up_lnk:8 "Guaranteed bit rate for uplink (0x00: Subscribed, 0xFE: 8640kbps, 0xFF: 0kbps)"
            {
                #if 0
...
/* under construction !*/
        ...
        min_qos.guarntd_bit_rate_down_lnk: "Guaranteed bit rate for downlink (0x00: Subscribed, 0xFE: 8640kbps, 0xFF: 0kbps)"
        {
            guarntd_bit_rate_down_lnk:8 "Guaranteed bit rate for downlink (0x00: Subscribed, 0xFE: 8640kbps, 0xFF: 0kbps)"
            {
                #if 0
...
/* under construction !*/
        ...
        min_qos.ext_max_bitrate_down_lnk: "Maximum bit rate for downlink (extended) (0x00: Use the value indicated by the Maximum bit rate for downlink (octet 9))"
        {
            ext_max_bitrate_down_lnk:8 "Maximum bit rate for downlink (extended) (0x00: Use the value indicated by the Maximum bit rate for downlink (octet 9))"
            {
                // 0x00: "Use the value indicated by the Maximum bit rate for downlink (octet 9)" ;
        ...
        min_qos.ext_guarntd_bit_rate_down_lnk: "Guaranteed bit rate for downlink (extended) (0x00: Use the value indicated by the Guaranteed bit rate for downlink in (octet 13))"
        {
            ext_guarntd_bit_rate_down_lnk:8 "Guaranteed bit rate for downlink (extended) (0x00: Use the value indicated by the Guaranteed bit rate for downlink in (octet 13))"
            {
                // 0x00: "Use the value indicated by the Guaranteed bit rate for downlink in (octet 13)" ;
        ...
        min_qos.ext_max_bitrate_up_lnk: "Maximum bit rate for uplink (extended) (0x00: Use the value indicated by the Maximum bit rate for uplink (octet 8))"
        {
            ext_max_bitrate_up_lnk:8 "Maximum bit rate for uplink (extended) (0x00: Use the value indicated by the Maximum bit rate for uplink (octet 8))"
            {
                // 0x00: "Use the value indicated by the Maximum bit rate for uplink (octet 8)" ;
        ...
        min_qos.ext_guarntd_bit_rate_up_lnk: "Guaranteed bit rate for uplink (extended) (0x00: Use the value indicated by the Guaranteed bit rate for downlink (octet 12))"
        {
            ext_guarntd_bit_rate_up_lnk:8 "Guaranteed bit rate for uplink (extended) (0x00: Use the value indicated by the Guaranteed bit rate for downlink (octet 12))"
            {
                // 0x00: "Use the value indicated by the Guaranteed bit rate for downlink (octet 12)" ;
