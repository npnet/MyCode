...
#endif
#ifdef  CHIP_MT6260
#define  CHIP_ID     CHIP_ID_MT6260
#endif
#ifdef  CHIP_MT6261
#define  CHIP_ID     CHIP_ID_MT6261
#endif
#ifdef  CHIP_MT2501
#define  CHIP_ID     CHIP_ID_MT6261
#endif
...
#define  IS_CHIP_MT6575                       ( CHIP_ID==CHIP_ID_MT6575 )
#define  IS_CHIP_MT6255                       ( CHIP_ID==CHIP_ID_MT6255 )
#define  IS_CHIP_MT6250                       ( CHIP_ID==CHIP_ID_MT6250 )
#define  IS_CHIP_MT6260                       ( CHIP_ID==CHIP_ID_MT6260 )
#define  IS_CHIP_MT6261                       ( CHIP_ID==CHIP_ID_MT6261 )
...
#define  IS_HYPER_SLEEP_MODE_CHIP             ((IS_CHIP_MT6238_SER || IS_CHIP_MT6516 || IS_CHIP_MT6268B || IS_CHIP_MT6253 || IS_CHIP_MT6236 || IS_CHIP_MT6256 || IS_CHIP_MT6251 || IS_CHIP_MT6276 || IS_CHIP_MT6573 || IS_CHIP_MT6575 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6260 || IS_CHIP_MT6261) && !defined(MT6516_S00) )
...
#define  IS_USC_CHIP                          ( IS_CHIP_MT6268B || IS_CHIP_SER_AND_LATTER(CHIP_ID_MT6270A) || IS_CHIP_MT6268H || IS_CHIP_MT6250 || IS_CHIP_MT6260 || IS_CHIP_MT6261 )
/* For Support Centralized Sleep Mode Manager Group */
#define  IS_CENTRALIZED_SMM_CHIP              ( IS_CHIP_MT6276 || IS_CHIP_MT6573 || IS_CHIP_MT6575 || IS_CHIP_MT6250 || IS_CHIP_MT6260 || IS_CHIP_MT6261 )
...
#define  IS_BSI_REG_32_BIT_CHIP               ( IS_CHIP_MT6268T || IS_CHIP_MT6268 || IS_CHIP_MT6268H || IS_CHIP_SER(CHIP_ID_MT6270A) || IS_CHIP_MT6250 || IS_CHIP_MT6260 || IS_CHIP_MT6261 )
/* For chip with 32-bit of BPI_ENA */
#define  IS_BPI_REG_32_BIT_CHIP               ( IS_CHIP_MT6268T || IS_CHIP_MT6268 || IS_CHIP_MT6268H || IS_CHIP_SER(CHIP_ID_MT6270A) )
...
/* For SOC chip Group */
#define  IS_SOC_CHIP                          ( IS_CHIP_SER(CHIP_ID_MT6253) || IS_CHIP_SER(CHIP_ID_MT6256) )
/* For 3G group */
...
#define  IS_CHIP_MT6250_S00                   ( (defined MT6250_S00) )
...
/*MT6250*/  #define  CHIP_ID     CHIP_ID_MT6250
   #endif
   #ifdef  MT6260
/*MT6260*/  #define  CHIP_ID     CHIP_ID_MT6260
   #endif
   #ifdef  MT6261
/*MT6261*/  #define  CHIP_ID     CHIP_ID_MT6261
   #endif
   #ifdef  MT2501
/*MT2051*/  #define  CHIP_ID     CHIP_ID_MT6261
   #endif
   #ifdef  MT2502
/*MT2502*/  #define  CHIP_ID     CHIP_ID_MT6261
   #endif
#endif
...
#define  IS_RF_MT6260RF    ( RF_ID==RF_ID_MT6260RF  )
#define  IS_RF_MT6261RF    ( RF_ID==RF_ID_MT6261RF  )
...
/*MT6250RF*/#define  RF_ID    RF_ID_MT6250RF
   #endif
   #ifdef  MT6260RF_RF
/*MT6260RF*/#define  RF_ID    RF_ID_MT6260RF
   #endif
   #ifdef  MT6261RF_RF
/*MT6261RF*/#define  RF_ID    RF_ID_MT6261RF
   #endif
   #ifdef  MT2501RF_RF
/*MT2501RF*/#define  RF_ID    RF_ID_MT6261RF
   #endif
   #ifdef  MT2502RF_RF
/*MT2502RF*/#define  RF_ID    RF_ID_MT6261RF
   #endif   
   #ifdef  MT6251RF_RF
...
#if defined(__GEMINI_MONITOR_PAGE_DURING_TRANSFER__) && IS_GEMINI_WGG_SUPPORT
   #if (NUM_OF_SIM>2) 
#error "Not support Gemini+ with Gemini 2.0 now"
   #endif
#define IS_GEMINI_2_0_WGG_SUPPORT                  1
#else
#define IS_GEMINI_2_0_WGG_SUPPORT                  0
#endif
...
#if IS_65NM_CHIP
   #if IS_CHIP_MT6268 || IS_CHIP_MT6516 || IS_CHIP_MT6236 || IS_CHIP_MT6276 || IS_CHIP_MT6573 || IS_CHIP_MT6251 || IS_CHIP_MT6575 || IS_CHIP_MT6256 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6260 || IS_CHIP_MT6261
      #if defined(MT6516_S00) || IS_CHIP_MT6251_S00 || IS_CHIP_MT6256_S00
#define IS_MD2G_PWD_SUPPORT                        0
      #else
#define IS_MD2G_PWD_SUPPORT                        1
      #endif
      #if IS_CHIP_MT6276 || IS_CHIP_MT6573 || IS_CHIP_MT6575 || IS_CHIP_MT6250 || IS_CHIP_MT6260 || IS_CHIP_MT6261
...
#define IS_IRDBG_LOG_STATUS                        1
   ...
   #if IS_CHIP_MT6268 || IS_CHIP_MT6516 || IS_CHIP_MT6236 || IS_CHIP_MT6276 || IS_CHIP_MT6573 || IS_CHIP_MT6251 || IS_CHIP_MT6575 || IS_CHIP_MT6256 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6260 || IS_CHIP_MT6261 //Later chip should apply new control flow
...
#define IS_COMPARE_DPRAM_CHIP                      0
   #else 
...
#if (IS_SOC_CHIP && !defined(__L1D_SOC_NO_MPLLFH__)) || IS_CHIP_MT6236
...
#if IS_CHIP_MT6251 || IS_CHIP_MT6252 || IS_CHIP_MT6256 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6260 || IS_CHIP_MT6261
...
#if IS_FOR_FACTORY_MODE_ONLY && (IS_CHIP_MT6229 || IS_CHIP_MT6238 || IS_CHIP_MT6223 || IS_CHIP_MT6253 || IS_CHIP_MT6225 || IS_CHIP_MT6516 || IS_CHIP_MT6236 || IS_CHIP_MT6268 || IS_CHIP_MT6276 || IS_CHIP_MT6573 || IS_CHIP_MT6575 || IS_CHIP_SER_AND_LATTER(CHIP_ID_MT6256))
...
#if IS_SAIC_CHIP_MT6253_AND_LATTER_VERSION && !IS_EDGE_SAIC_CHIP_MT6256_AND_LATTER_VERSION
   #if defined(L1D_TEST)
...
#if IS_CHIP_MT6516 || IS_CHIP_MT6236 || IS_EDGE_SAIC_CHIP_MT6256_AND_LATTER_VERSION
...
#if IS_EDGE_SAIC_CHIP_MT6236_AND_LATTER_VERSION && !(IS_CHIP_MT6256 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6260 || IS_CHIP_MT6261)
...
//TDD Dual Mode Feature Option
#if IS_TDD_DUAL_MODE_SUPPORT
   #if IS_CHIP_MT6256 || IS_CHIP_MT6255
...
#elif IS_CHIP_MT6236 || IS_CHIP_MT6252 || IS_CHIP_MT6573 || IS_CHIP_MT6256 || IS_CHIP_SER_AND_LATTER(CHIP_ID_MT6255)
...
#define IS_DSP_ENHANCE_SHORT_FBSB_SUPPORT          0
   ...
   #if IS_CHIP_MT6573 || IS_CHIP_MT6256 || IS_CHIP_SER_AND_LATTER(CHIP_ID_MT6255)
...
#elif IS_CHIP_MT6250 || IS_CHIP_MT6260
#define IS_INBAND_BLOCKER_DETECTION_SUPPORT        1
...
#endif
#if  IS_RF_MT6261RF
#define IS_INBAND_BLOCKER_RX_GAIN_TABLE_SUPPORT    0
#define IS_HEADROOM_RX_GAIN_TABLE_SUPPORT          0
#endif

#if IS_RF_MT6256RF || IS_RF_MT6251RF || IS_RF_MT6252RF || IS_RF_MT6255RF || IS_RF_MT6162 || IS_RF_MT6250RF || IS_RF_MT6260RF || IS_RF_MT6261RF
#define IS_DYNAMIC_MACRO_SUPPORT                   1
#else
#define IS_DYNAMIC_MACRO_SUPPORT                   0
#endif

/* KCAL_COMP_TC_GAIN is subset of TEMP_COMP_TC_GAIN */
/* TEMP_COMP_TC_GAIN is subset of BAND_COMP_TC_GAIN */
#if IS_RF_MT6250RF || IS_RF_MT6260RF
#define IS_BAND_COMP_TC_GAIN_SUPPORT               1
#define IS_TEMP_COMP_TC_GAIN_SUPPORT               1
#define IS_KCAL_COMP_TC_GAIN_SUPPORT               1
#elif IS_RF_MT6256RF
#define IS_BAND_COMP_TC_GAIN_SUPPORT               1
#define IS_TEMP_COMP_TC_GAIN_SUPPORT               1
#define IS_KCAL_COMP_TC_GAIN_SUPPORT               0
#else
#define IS_BAND_COMP_TC_GAIN_SUPPORT               0
#define IS_TEMP_COMP_TC_GAIN_SUPPORT               0
#define IS_KCAL_COMP_TC_GAIN_SUPPORT               0
#endif

#if IS_EDGE_SAIC_CHIP_MT6256_AND_LATTER_VERSION || IS_CHIP_MT6252
...
#define IS_W_CANCELLATION_SUPPORT                  1
   #endif
#elif IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6260 || IS_CHIP_MT6261
#define IS_MT6251_DCR_MODE                         0
#define IS_MT6256_DCR_MODE                         0
#define IS_W_CANCELLATION_SUPPORT                  1
#define IS_MT6251_E1_FT                            0
...
#define IS_WDT_RESET_BUG_SW_WORKAROUND_NEEDED      1
#elif IS_CHIP_MT6250 || IS_CHIP_MT6261
#define IS_SW_SECOND_VERSION_NEEDED                1
#define IS_WDT_RESET_BUG_SW_WORKAROUND_NEEDED      1
#else
#define IS_SW_SECOND_VERSION_NEEDED                0
#define IS_WDT_RESET_BUG_SW_WORKAROUND_NEEDED      0
#endif
...
#define IS_WC_IMM_MODE_ENABLE                      0
   ...
   #if IS_RF_MT6256RF || IS_RF_MT6162
...
#if IS_CHIP_MT6251 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6260 || IS_CHIP_MT6261
...
#if ( IS_CHIP_MT6255 || IS_CHIP_MT6256 ) && defined(__AST3001__)
...
#if defined(L1_SIM) && defined(__CENTRALIZED_SLEEP_MANAGER__)
#undef  IS_CENTRALIZED_SMM_CHIP
#define IS_CENTRALIZED_SMM_CHIP                    1
#endif

#if (IS_CHIP_MT6250 || IS_CHIP_MT6260) && defined(MTK_SLEEP_ENABLE)
#define IS_TDMA_TWO_STAGE_RF_POWERON_SUPPORT       1
#else
#define IS_TDMA_TWO_STAGE_RF_POWERON_SUPPORT       0
#endif

#if (IS_CHIP_MT6250 || IS_CHIP_MT6260 || IS_CHIP_MT6261) && defined(MTK_SLEEP_ENABLE)
...
#define IS_NORMAL_MODE_CAPID_CAL_SUPPORT           1
#else
#define IS_NORMAL_MODE_CAPID_CAL_SUPPORT           0
#endif
...
#if IS_CHIP_MT6256 || IS_EDGE_SAIC_CHIP_MT6270A_AND_LATTER_VERSION || IS_CHIP_MT6252 || IS_CHIP_SER_AND_LATTER(CHIP_ID_MT6255)
...
#define IS_BSI_V1_SUPPORT                          (!IS_BSI_V2_SUPPORT)
   ...
   #if IS_CHIP_MT6256 || IS_CHIP_MT6252 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6260 || IS_CHIP_MT6261
#define IS_BSI_V2_ST2_SUPPORT                      0
   #elif IS_CHIP_MT6251 || IS_EDGE_SAIC_CHIP_MT6270A_AND_LATTER_VERSION
...
#define IS_RF_TX_CALIBRATION_SUPPORT               0
   #endif
   #if  defined(AFC_VCXO)
      #if IS_FDD_DUAL_MODE_SUPPORT                   /* NOTE: IS_MT6162_DCXO_SUPPORT and IS_AFC_TRIGGER_BSI_SUPPORT   */
#define IS_MT6162_DCXO_SUPPORT                     0 /*       can NOT be 1 at the same time                           */
#define IS_AFC_TRIGGER_BSI_SUPPORT                 1 /* use the AFC module to trigger BSI to send AFCDAC values to RF */
      #else
#define IS_MT6162_DCXO_SUPPORT                     1 /* use the BSI module directly to send AFCDAC values to RF       */
#define IS_AFC_TRIGGER_BSI_SUPPORT                 0
      #endif
   #else
#define IS_MT6162_DCXO_SUPPORT                     0
#define IS_AFC_TRIGGER_BSI_SUPPORT                 0
   #endif
#else
...
#if IS_CACHE_DSP_SUPPORT || IS_CHIP_SER_AND_LATTER(CHIP_ID_MT6255)
...
#elif IS_CHIP_MT6256 || IS_CHIP_MT6573 || IS_CHIP_MT6575 || IS_CHIP_SER_AND_LATTER(CHIP_ID_MT6255)
...
// HW clock gating
#if IS_CHIP_SER_AND_LATTER(CHIP_ID_MT6255)
...
#define IS_DYNAMIC_G_E_TXWIN_POSITION_SUPPORT_V2   0  /* Change the GMSK and EPSK TX window positions dynamically by frames */
                                                      /* according to the modulation type of the first TX slot in each frame. */
   #elif IS_CHIP_MT6256
...
/* under construction !*/
#else
#define IS_USB_LOGGING_SUPPORT                     0
#endif
...
#if IS_SOC_CHIP || IS_EDGE_SAIC_CHIP_MT6270A_AND_LATTER_VERSION
...
#elif IS_SOC_CHIP || IS_MT6162_DCXO_SUPPORT
...
#if IS_RF_AD6548 || IS_RF_MT6139B || IS_RF_MT6139C || IS_RF_MT6139E || IS_RF_MTKSOC1 || IS_RF_MT6252RF || IS_RF_MT6251RF || IS_RF_MT6255RF || IS_RF_MT6250RF || IS_RF_MT6260RF || IS_RF_MT6261RF
...
#if IS_RF_MT6252RF || IS_RF_MT6251RF || IS_RF_MT6256RF || IS_RF_MT6255RF || IS_RF_MT6162 || IS_RF_MT6250RF || IS_RF_MT6260RF || IS_RF_MT6261RF
...
#if IS_CHIP_SER_AND_LATTER(CHIP_ID_MT6250)
...
#if defined(L1D_TEST) && IS_CHIP_SER_AND_LATTER(CHIP_ID_MT6250)
#define IS_COSIM_IRDMA_MPU_FULL_TEST_SUPPORT       1
#else
#define IS_COSIM_IRDMA_MPU_FULL_TEST_SUPPORT       0
#endif

#if defined(__UDVT__) && IS_CHIP_SER_AND_LATTER(CHIP_ID_MT6250)
...
#if defined(__RX_G2_HIGH_GAIN_MODE_DE_FEATURE_SAWLESS__) && (IS_CHIP_MT6261)
#define IS_RX_G2_HIGH_GAIN_MODE_DE_FEATURE_SAWLESS    1
#else
#define IS_RX_G2_HIGH_GAIN_MODE_DE_FEATURE_SAWLESS    0
#endif

#if IS_CHIP_MT6250 || IS_CHIP_MT6260 || IS_CHIP_MT6261
#define IS_MPU_BASE_SIZE_CHANGE_SUPPORT            1
#else
#define IS_MPU_BASE_SIZE_CHANGE_SUPPORT            0
#endif
...
#if IS_DSP_RX_DCOC_SUPPORT && defined( __IS_DSP_RX_DCOC_FORCE_ON_ENABLE__ )
#define IS_DSP_RX_DCOC_FORCE_ON_ENABLE             1
#else
#define IS_DSP_RX_DCOC_FORCE_ON_ENABLE             0
#endif

// There are to methods to solve TC21.1
...
//    => IS_BFE_RX_TYPE_NB_EN_SUPPORT (MT6260 BFE HW adds this new function)
#if IS_CHIP_MT6260 || IS_CHIP_MT6261
...
#if IS_CHIP_MT6250 || IS_CHIP_MT6260 || IS_CHIP_MT6261 || IS_EDGE_SAIC_CHIP_MT6270A_AND_LATTER_VERSION
...
#if IS_CHIP_MT6256 || IS_CHIP_SER_AND_LATTER(CHIP_ID_MT6255)
...
#if IS_CHIP_MT6260
#define IS_CHECK_VCORE_OC_SUPPORT                  1
#else
#define IS_CHECK_VCORE_OC_SUPPORT                  0
#endif



#define MT6261_BSI_DEBUG                           0
...
/*              CHIP ZIMAGE setting                                  */
/*===================================================================*/
#if IS_CHIP_MT6252 || IS_CHIP_MT6250 || IS_CHIP_MT6260 || IS_CHIP_MT6261
...
// default value
/* ------------------------------------------------------------- */
#if IS_CHIP_MT6205 || IS_CHIP_MT6225 || IS_CHIP_MT6223 || IS_CHIP_MT6238_SER || IS_CHIP_MT6276 || IS_CHIP_MT6251 || IS_CHIP_MT6573 || IS_CHIP_MT6252 || IS_CHIP_MT6256 || IS_CHIP_MT6575 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6260 || IS_CHIP_MT6261
#define INTERNCODE_DEFAULT                         INTERN_NULL
#else
#define INTERNCODE_DEFAULT                         INTERN_FULL
#endif
/* ------------------------------------------------------------- */
#if IS_CHIP_MT6205 || IS_CHIP_MT6225 || IS_CHIP_MT6223 || IS_CHIP_MT6238_SER || IS_CHIP_MT6276 || IS_CHIP_MT6253 || IS_CHIP_MT6251  || IS_CHIP_MT6573 || IS_CHIP_MT6256 || IS_CHIP_MT6575 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6260 || IS_CHIP_MT6261
...
#define INTERNCODE_M12120                          INTERN_PARTIAL
   #endif
/* ------------------------------------------------------------- */
#elif IS_CHIP_MT6252 || IS_CHIP_MT6250 || IS_CHIP_MT6260
/* ------------------------------------------------------------- */
#undef  INTERNCODE_M11303
#undef  INTERNCODE_M12110
#undef  INTERNCODE_M12120
