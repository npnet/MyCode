 ...
 * $Log$
 *
 * 05 18 2012 wenke.zhou
 * [MAUI_03185543] [check-in]WiFi power save
 * .
 *
 * 05 11 2012 wenke.zhou
 * [MAUI_03184230] Revise the trace info.
 * .
 *
 * 06 09 2011 wenke.zhou
 * [MAUI_02958759] Network roaming support.
 * .
 *
 * 05 24 2011 leona.chou
 * [MAUI_02918826] [CMCC WIFI TD] Add CMCC verification
 * .
 *
 ...
 * 
 *
 * Dec 25 2009 mtk01890
 * [MAUI_01974100] 3GPP streaming link-char support (QoS related)
 * 
 *
 * Oct 28 2009 mtk01890
 * [MAUI_01905183] [For TPE check-in] CMCC DM LAWMO and SCOMO
 * 
 *
 * Sep 18 2009 mtk01890
 * [MAUI_01957963] [ABM] bearer management revise
 * 
 *
 * Aug 4 2009 mtk01890
 ...
 *
 * Jul 8 2009 mtk01890
 * [MAUI_01717159] Call history enhancement
 * 
 *
 * Feb 4 2009 mtk01890
 * [MAUI_01323028] [SOC] fix potential buf of abm_reset
 * 
 *
 * Jan 9 2009 mtk01890
 * [MAUI_01313140] [CBM] revise the function of cbm_register_app_bearer_info
 * 
 *
 * Dec 25 2008 mtk01890
 * [MAUI_01305123] [CBM] revise the API naming
 * 
 *
 * Nov 4 2008 mtk01890
 * [MAUI_01268355] [CBM] remove the outdated bearer info api cbm_set_bearer_info
 * 
 *
 * Oct 23 2008 mtk01890
 * [MAUI_01189822] [obigo q05a brower]  will prompt "Download:  switch to second bearer CSD?" for two t
 * 
 *
 * Oct 6 2008 mtk01890
 * [MAUI_01249934] [ABM] add edge icon support
 * 
 *
 * Aug 16 2008 mtk01890
 * [MAUI_00823515] [CBM] support application session in bearer fallback
 * 
 *
 * Aug 6 2008 mtk01890
 * [MAUI_00817965] [ABM] check in sim provisioning
 * 
 *
 * Jul 29 2008 mtk01890
 * [MAUI_00802428] [CBM] check-in CBM 2.0 bearer fallback
 * 
 *
 * Jun 21 2008 mtk01890
 * [MAUI_00786908] [CBM 2.0] check in CBM 2.0 bearer mangement
 * 
 *
 * Jun 20 2008 mtk01890
 * [MAUI_00786908] [CBM 2.0] check in CBM 2.0 bearer mangement
 * 
 *
 ...
 *
 * Apr 2 2008 mtk01890
 * [MAUI_00748277] [ABM] add trace message
 * 
 *
 * Feb 23 2008 mbj06071
 * [MAUI_00629822] [change feature] fro 6223C+ project
 * 
 *
 * Oct 11 2006 mtk01175
 * [MAUI_00335154] [VoWLAN] WLAN Data Account check-in
 * 
 *
 *------------------------------------------------------------------------------
...
BEGIN_TRACE_MAP(MOD_ABM)
   ...
   TRC_MSG(STATE_ABM_APP_BEARER_TRANSITION, "[ABM] app bearer transition=>%Mabm_app_account_state_enum")
