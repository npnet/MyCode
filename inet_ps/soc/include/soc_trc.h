 ...
 * [MAUI_02846265] [RHR] remove header files
 * .
 *
 * 11 23 2010 leona.chou
 * [MAUI_02841071] [NWK] check in maui SDK
 * .
 *
 * 10 18 2010 fei.hao
 * [MAUI_02637838] [For codegen] split "ps_trace.h" check-in
 * .
 *
 ...
 * 
 *
 * Nov 10 2009 mtk01890
 * [MAUI_01907171] [Videoplayer] after play audio streaming, open page fail
 * 
 *
 * Sep 18 2009 mtk01890
 * [MAUI_01957995] [SOC] network bearer management revision
 * 
 *
 * Jul 24 2009 mtk01890
 * [MAUI_01765383] [1] Fatal Error (305, 88880064) - L4
 * 
 *
 * Apr 17 2009 mtk01890
 * [MAUI_01671049] [SOC/ABM] check network unit test tool
 * 
 *
 ...
 *
 * Feb 19 2008 mtk01890
 * [MAUI_00610000] [CBM] account modified from u8 to u32
 * [MAUI_00626652] [Obigo MMS] can not deactivate SIM2 GPRS
 * 
 *
 ...
 *
 * Sep 7 2007 MTK01264
 * [MAUI_00463780] [1] Fatal Error (405): kal_give_mutex: The mutex is taken by another task (2e791cc)
 * Drop 7-bit encoding WAP push message
 *
 ...
 * [MAUI_00385039] [SOC] Pass smsc number in fromaddr
 * Embeded smsc number in the free header space after peer buffer struct
 *
 * Apr 19 2007 MTK01264
 * [MAUI_00383503] [WLAN] get ip failed
 * Return SOC_WOULDBLOCK if local IP address is zero
 *
 * Mar 26 2007 MTK01264
 * [MAUI_00376004] [SOC] default public DNS server
 * Add auxiliary public DNS servers
 *
 * Mar 19 2007 MTK01264
 * [MAUI_00422592] [Obigo MMS] [1] Fatal Error: msg_send_ext_queue() failed 1=305 2=8888004e -SOC
 * Notify receive indication only when the receive queue is empty
 *
 ...
 *
 * Feb 3 2007 MTK01264
 * [MAUI_00229752] [1] Assert fail: peer_ptr[cur_idx] != NULL soc_common.c 2861 - IPERF
 * Free allocated SSPDU while blocking socket returning error
 *
 ...
 *
 * Jan 9 2007 MTK01264
 * [MAUI_00357470] [SOC] sends ILM for soc_close_nwk_account()
 * Unify soc_close_nwk_account()
 *
 * Jan 9 2007 MTK01264
 * [MAUI_00357470] [SOC] sends ILM for soc_close_nwk_account()
 * Replace function call with a message
 *
 * Dec 29 2006 MTK01264
 * [MAUI_00228606] [1] Fatal Error (804): Buffer not available - TCPIP
 * Limit total sockets opened by WAP
 *
 ...
 *
 * Dec 20 2006 MTK01264
 * [MAUI_00352344] [VoIP] Sometimes can't automatic re-login
 * Reset IP address in account context for deactivate cnf
 *
 * Dec 19 2006 MTK01264
 * [MAUI_00352285] [SOC] set and judge dhcp_state in deactivate_cnf for bearers other than Wi-Fi
 * Only skip sockets in IP acquiring state for Wi-Fi bearer sockets
 *
 * Dec 6 2006 MTK01264
 ...
 *
 * Dec 3 2006 MTK01264
 * [MAUI_00227608] VOIP1.0_ Login SIP server,pop up "DNS error".
 * Set appropriate network account id for retransmission
 *
 * Nov 29 2006 MTK01264
 * [MAUI_00347045] [SOC] stop_timer for matching sub_id
 * Matching sub_id for soc_stop_timer()
 *
 * Nov 26 2006 MTK01264
 * [MAUI_00227361] Assert Fail: (SOC_SMS_PQ_MAGIC<=timer_soc_timer.c 209 - SOC
 * Add sub id for socket timers
 *
 * Nov 24 2006 MTK01264
 * [MAUI_00226983] Assert fail: KAL_FALSE gprs_flc_soc_thres_callback.c 351 - WPS
 * Fix bug for deactivating SRPDU while activating multiple PDP contexts
 *
 * Nov 20 2006 MTK01264
 * [MAUI_00344530] [SOC] Add traces for FLC
 * Log event for configuring bearer to FLC
 *
 * Nov 12 2006 MTK01264
 * [MAUI_00342491] [SOC] Modifications for socket enhancement
 * Modifications for socket ehnancement since w06.46
 *
 * Oct 16 2006 MTK01264
 * [MAUI_00336505] [SOC] Activate SRPDU at boot-up and never deactivated
 * Activate SRPDU at boot-up and never deactivate it
 *
 * Oct 11 2006 MTK01264
 * [MAUI_00335073] [SOC] Check in VoWLAN feature
 * Support for VoIP feature
 *
 * Feb 11 2006 mtk00435
 * [MAUI_00172669] [SOC] Add traces for SRPDU activate/deactivate
 * 
 *
 *------------------------------------------------------------------------------
