...
typedef enum
{
	...
	Bird_task_24calib_Timer,
       ...
       Bird_task_postinfo_Timer,
       BIRD_TASK_3D_SENSOR_TIMER,
       BIRD_TASK_VIBRATION_TIMER,
       BIRD_TASK_VIBRATION_TIMER_COUNT,
       BIRD_TASK_YD_NORMAL_SLEEP_TIMER,
       BIRD_TASK_SOCKET_SEND,
       BIRD_TASK_SOCKET_RECON,
       BIRD_TASK_SET_KEYON_DELAY_TIMER,
       RJ_TASK_GPS_RESET_TIMER,
       BIRD_TASK_HEART_START_TIMER,
       BIRD_TASK_GPS_START_TIMER,
       BIRD_TASK_YD_UPLOAD_CALLER_TIMER,
       BIRD_TASK_ACTIVE_MSG_TIMER,
       BIRD_TASK_SET_DEFENSE_DELAY_TIMER,
       BIRD_TASK_POWER_OFF_DELAY,
       BIRD_TASK_DW_TIMER,
       BIRD_TASK_LEARN_TIMER,
       BIRD_TASK_YD_DEEP_SLEEP_TIMER,
       Bird_task_sleep_dinisocket_Timer,
       Bird_task_low_delay_Timer,
       Bird_task_power_alarm_Timer,
       BIRD_TASK_SCHYE_TIMER,
       BIRD_TASK_LOW_REST_TIMER,
       BIRD_TASK_REST_TIMER,
       BIRD_TASK_24REST_TIMER,
       BIRD_TASK_REG_KEY_TIMER,
       BIRD_TASK_LC_TJ_TIMER,
       BIRD_TASK_REG_CLEAR_TIMER,
       ...
       Bird_task_restartflag_timer,
       Bird_task_acc_power_timer,
       Bird_task_bdtest_timer,// add by lqy
...
extern void Rj_start_timer(kal_uint8 timer_id, kal_uint32 period, kal_timer_func_ptr timer_expiry, void *arg);
extern void Rj_stop_timer(kal_uint8 timer_id);
