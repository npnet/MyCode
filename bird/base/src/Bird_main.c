...
void Bird_LED_Identify_Wink(void)
{
	...
	{
		kal_prompt_trace(MOD_SOC,"[LED] SIM Searching");
	...
	{
		kal_prompt_trace(MOD_SOC,"[LED] GSM Searching");
	...
	{
		kal_prompt_trace(MOD_SOC,"[LED] SOC Connecting");
	...
	{
		kal_prompt_trace(MOD_SOC,"[LED] Login");
	...
	{
		kal_prompt_trace(MOD_SOC,"[LED] GPS Searching");
	...
	{
		kal_prompt_trace(MOD_SOC,"[LED] GPS Search Done");
		cus_leds_led2_light(1);
		cus_leds_set_led2_light_status(1);
	...
	{
		kal_prompt_trace(MOD_SOC,"[LED] GPS Close");
		cus_leds_led2_light(0);
		cus_leds_set_led2_light_status(0);
	}
	else
