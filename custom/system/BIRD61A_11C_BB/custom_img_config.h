 ...
 * Author:
 * -------
 *   Carlos Yeh (mtk02377)     system auto generatorv6.99 -> p7.00 -> p7.01 -> p7.04 -> p7.05 -> p7.09 -> p7.14 + scatFrame v0.12 + sysGenUtility v0.42 -> p0.43 -> p0.44 -> p0.45 -> p0.49
 *
 *============================================================================
 *             HISTORY
...
#define FOTA_MAUI_IMAGE_AMOUNT     (1)
      ...
      #define MAX_LENGTH_DSP_ROM  (0x100000)
            ...
            #define MAX_LENGTH_ROM  (MAX_ROM_SIZE)
         #else  /* MAX_ROM_SIZE */
            #define MAX_LENGTH_ROM  (0x006A0000)
         #endif  /* MAX_ROM_SIZE */
      #else
         #define MAX_LENGTH_ROM     (0xFFFFFFFF)
      #endif
...
#define FOTA_PACKAGE_STORAGE_BASE  (0x10780000)

#define FOTA_PACKAGE_STORAGE_SIZE  (0x00000000)

#define FOTA_PACKAGE_BLOCK_NUMBER  (4)

#define FOTA_BACKUP_STORAGE_BASE   (0x10780000)
