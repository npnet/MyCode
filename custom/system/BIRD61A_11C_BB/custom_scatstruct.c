 ...
 * Author:
 * -------
 *   Claudia Lo (mtk01876)     system auto generator v1.70 -> p1.71 -> p1.72 -> p1.74 -> p1.75 + sysGenUtility v0.42 -> p0.43 -> p0.44 -> p0.45 -> p0.49
 * 
 *============================================================================
 *             HISTORY
 ...
 * .
 *
 * 01 17 2014 yinli.liang
 *  [6261 Driver][System Service][MAUI Kernel Internal Request] replace INT_RetrieveDSPTXRXBaseAddr() by scatstruct API
 * .
 *
...
extern kal_uint32 Image$$DYNAMIC_COMP_CODE$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_CODE$$RO$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_CODE$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_CODE$$RO$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_CODE$$ZI$$Limit;
extern kal_uint32 Image$$DYNAMIC_COMP_BESLOUDNESS$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_BESLOUDNESS$$RO$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_BESLOUDNESS$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_BESLOUDNESS$$RO$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_BESLOUDNESS$$ZI$$Limit;
extern kal_uint32 Image$$DYNAMIC_COMP_BESLOUDNESS_BODY$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_BESLOUDNESS_BODY$$RO$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_BESLOUDNESS_BODY$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_BESLOUDNESS_BODY$$RO$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_BESLOUDNESS_BODY$$ZI$$Limit;
extern kal_uint32 Image$$DYNAMIC_COMP_VEENC$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_VEENC$$RO$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_VEENC$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_VEENC$$RO$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_VEENC$$ZI$$Limit;
extern kal_uint32 Image$$DYNAMIC_COMP_VEENC_BODY$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_VEENC_BODY$$RO$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_VEENC_BODY$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_VEENC_BODY$$RO$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_VEENC_BODY$$ZI$$Limit;
extern kal_uint32 Image$$DYNAMIC_COMP_VEDEC$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_VEDEC$$RO$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_VEDEC$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_VEDEC$$RO$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_VEDEC$$ZI$$Limit;
extern kal_uint32 Image$$DYNAMIC_COMP_VEDEC_BODY$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_VEDEC_BODY$$RO$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_VEDEC_BODY$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_VEDEC_BODY$$RO$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_VEDEC_BODY$$ZI$$Limit;
extern kal_uint32 Image$$DYNAMIC_COMP_WAVETABLE$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_WAVETABLE$$RO$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_WAVETABLE$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_WAVETABLE$$RO$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_WAVETABLE$$ZI$$Limit;
extern kal_uint32 Image$$DYNAMIC_COMP_WAVETABLE_BODY$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_WAVETABLE_BODY$$RO$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_WAVETABLE_BODY$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_WAVETABLE_BODY$$RO$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_WAVETABLE_BODY$$ZI$$Limit;
extern kal_uint32 Image$$DYNAMIC_COMP_MAUIINIT$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_MAUIINIT$$RO$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_MAUIINIT$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_MAUIINIT$$RO$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_MAUIINIT$$ZI$$Limit;
extern kal_uint32 Image$$DYNAMIC_COMP_MAUIINIT_BODY$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_MAUIINIT_BODY$$RO$$Base;
extern kal_uint32 Image$$DYNAMIC_COMP_MAUIINIT_BODY$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_MAUIINIT_BODY$$RO$$Length;
extern kal_uint32 Image$$DYNAMIC_COMP_MAUIINIT_BODY$$ZI$$Limit;
...
{
    region->addr = (kal_uint32)&Image$$DYNAMIC_COMP_WAVETABLE$$Base;
    region->len = (kal_uint32)&Image$$DYNAMIC_COMP_BESLOUDNESS_BODY$$Base + 0x35a0 - region->addr;
}
...
kal_uint32 custom_query_dump_region(EXTSRAM_REGION_INFO_T* region)
{
    ...
    region[1].addr = (kal_uint32)&Image$$SINGLE_BANK_CODE$$Base;
    region[1].len = (kal_uint32)&Image$$EXTSRAM$$ZI$$Limit - region[1].addr;
    region[2].addr = (kal_uint32)&Image$$EXTSRAM_DSP_TX$$Base;
    region[2].len = 0x6000;
    region[3].addr = (kal_uint32)&Image$$EXTSRAM_DSP_RX$$Base;
    region[3].len = 0xf000;
    region[4].addr = (kal_uint32)&Image$$DYNAMIC_CACHEABLE_EXTSRAM_DEFAULT_CACHEABLE_RW$$Base;
    region[4].len = (kal_uint32)&Image$$DYNAMIC_CACHEABLE_EXTSRAM_DEFAULT_CACHEABLE_ZI$$ZI$$Limit - region[4].addr;
    region[4].addr = MAP2CREGPA(region[4].addr);
    region[5].addr = 0x0;
    region[5].len = 0x200;
    region[6].addr = (kal_uint32)&Image$$CACHED_EXTSRAM$$Base;
    region[6].len = (kal_uint32)&Image$$EXTSRAM_GADGET$$ZI$$Limit - region[6].addr;
    region[7].addr = (kal_uint32)&Image$$DYNAMIC_CACHEABLE_EXTSRAM_DEFAULT_NONCACHEABLE_ZI_MMIPOOL$$Base;
    region[7].len = (kal_uint32)&Image$$DYNAMIC_CACHEABLE_EXTSRAM_DEFAULT_NONCACHEABLE_RW$$ZI$$Limit - region[7].addr;
    region[7].addr = MAP2CREGVA(region[7].addr);
    region[8].addr = (kal_uint32)&Image$$DYNAMIC_COMP_WAVETABLE$$Base;
    region[8].len = (kal_uint32)&Image$$DYNAMIC_COMP_BESLOUDNESS_BODY$$Base + 0x35a0 - region[8].addr;
    region[9].addr = (kal_uint32)&Image$$DYNAMIC_CACHEABLE_EXTSRAM_DEFAULT_CACHEABLE_RW$$Base;
    region[9].len = (kal_uint32)&Image$$DYNAMIC_CACHEABLE_EXTSRAM_DEFAULT_CACHEABLE_ZI$$ZI$$Limit - region[9].addr;
    region[10].addr = (kal_uint32)&Image$$INTSRAM_CODE$$Base;
    region[10].len = 0x1200;
    region[11].addr = (kal_uint32)&Image$$INTSRAM_DATA$$Base;
    region[11].len = 0xe00;
...
kal_bool custom_check_code_address(kal_uint32 address)
{
    ...
    TOTAL_CODE_REGION[5].addr = (kal_uint32)&Image$$DYNAMIC_COMP_WAVETABLE$$RO$$Base;
    TOTAL_CODE_REGION[5].len = (kal_uint32)&Image$$DYNAMIC_COMP_BESLOUDNESS_BODY$$RO$$Base + 0x35a0 - TOTAL_CODE_REGION[5].addr;
