 ...
 */
    #define GLOBAL_MEM_SIZE    (166800 + 19052)
    #define GLOBAL_DEBUG_MEM_SIZE    1312
    #define GLOBAL_HISR_SHARED_IRAM_STACK_SIZE  (3584)
    #define GLOBAL_TOTAL_CREATED_TASK_NUMBER    (31)
#endif  
