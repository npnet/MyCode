/* EasyCASE V6.5 02/09/2010 13:49:43 */
/* EasyCASE O
If=vertical
LevelNumbers=no
LineNumbers=no
...
#define BMA222_I2C_ADDR1                0x18    //0x08
#define BMA222_I2C_ADDR                 BMA222_I2C_ADDR1
#define BMA222_I2C_ADDR2               0x31   // 0x09
...
#define bma222_INT_ENABLEXYZ_REG                  0x18
...
#define bma222_SLOPE_NO_MOTION_DURN_REG 0x27


#define bma222_SLOPE_NO_MOTION_THRES_REG                  0x29
...
#define bma222_EN_HIGHG_XYZ_INT__POS         0                     //  ranyingchun   2
#define bma222_EN_HIGHG_XYZ_INT__LEN         3                         //  ranyingchun   1 
#define bma222_EN_HIGHG_XYZ_INT__MSK         0x07                    //  ranyingchun   0x04
...
#define bma222_EN_INT1_PAD_NO_MOTION_SLOPE__POS       3
#define bma222_EN_INT1_PAD_NO_MOTION_SLOPE__LEN       1
#define bma222_EN_INT1_PAD_NO_MOTION_SLOPE__MSK       0x08
#define bma222_EN_INT1_PAD_NO_MOTION_SLOPE__REG       bma222_INT1_PAD_SEL_REG
...
/* EasyCASE - */
/*****               SLOPE NO MOTION THRESHOLD                       ******/


#define bma222_SLOPE_NO_MOTION_DUR__POS                    2
#define bma222_SLOPE_NO_MOTION_DUR__LEN                    6
#define bma222_SLOPE_NO_MOTION_DUR__MSK                    0xFC    // ranyingchun  0xFA
#define bma222_SLOPE_NO_MOTION_DUR__REG                    bma222_SLOPE_NO_MOTION_DURN_REG      
/* EasyCASE - */
/*****               SLOPE NO MOTION THRESHOLD                       ******/

#define bma222_SLOPE_NO_MOTION_THRES__POS                  0
#define bma222_SLOPE_NO_MOTION_THRES__LEN                  8
#define bma222_SLOPE_NO_MOTION_THRES__MSK                  0xFF
#define bma222_SLOPE_NO_MOTION_THRES__REG                    bma222_SLOPE_NO_MOTION_THRES_REG
...
#define bma222_RANGE_2G                3// 0 /**< sets range to +/- 2G mode \see bma222_set_range() */
#define bma222_RANGE_4G                 5  // 1 /**< sets range to +/- 4G mode \see bma222_set_range() */
#define bma222_RANGE_8G                 8  //  2 /**< sets range to +/- 8G mode \see bma222_set_range() */
#define bma222_RANGE_16G                0x0c  //  3 /**< sets range to +/- 16G mode \see bma222_set_range() */
...
#define bma222_LOW_TH_IN_G( gthres, range)                      ((256 * gthres ) / 2) 
...
int bma222_set_low_duration(unsigned char duration);
/* EasyCASE ) */
/* EasyCASE ( 1049
   bma222_get_low_duration */
int bma222_get_low_duration(unsigned char *status );
/* EasyCASE ) */
/* EasyCASE ( 1051
...
int bma222_set_flat_holt_time(unsigned char holdtime);
/* EasyCASE ) */
/* EasyCASE ( 1104
   bma222_get_flat_holt_time */
int bma222_get_flat_holt_time(unsigned char *holdtime );
/* EasyCASE ) */
/* EasyCASE ( 1106
...
#ifdef DW06A_PCB
extern void bma222_high_g_interrupt_mode(void);
extern void bma222_slope_no_motion_interrupt_mode(void);
extern int bma222_set_high_g_interrupt_threshold(float threshold);
extern int bma222_set_slope_motion_threshold(unsigned char threshold);
#endif
#endif
#endif
/* EasyCASE ) */
