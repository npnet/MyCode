...
ifneq ($(strip $(VENUS_MMI)),NONE)
  ...
  ifeq ($(strip $(PLATFORM)),MT6261)
    $(warning ERROR: please set VENUS_MMI as NONE when PLATFORM is MT6261)
    DEPENDENCY_CONFLICT = TRUE
  endif
...
ifdef DUAL_MEMORY_CARD_SUPPORT
  ifneq ($(strip $(DUAL_MEMORY_CARD_SUPPORT)),NONE)
    ifneq ($(strip $(MSDC_CARD_SUPPORT_TYPE)),MSDC_SD_MMC)
      $(call DEP_ERR_SETA_OR_OFFB,MSDC_CARD_SUPPORT_TYPE,MSDC_SD_MMC,DUAL_MEMORY_CARD_SUPPORT)
      DEPENDENCY_CONFLICT = TRUE
    else
...
ifeq ($(strip $(DSP_RX_DCOC_FORCE_ON_ENABLE)),TRUE)
  COM_DEFS += __IS_DSP_RX_DCOC_FORCE_ON_ENABLE__
endif
...
ifeq ($(strip $(RJ_GPS_SUPPORT)),TRUE)
	COM_DEFS += RJ_GPS_APP
       COM_DEFS += DW02_PROJECT
	#COM_DEFS += RJ_GPS_LONG_CONNECT
	#COM_DEFS += RJ_GPS_FOR_LIMA

	#下面两个是基站功能宏
	COM_DEFS += RJ_GPS_APP_AGPS		
	COM_DEFS += __NBR_CELL_INFO__

	COM_DEFS += __BIRD_YD_TK001__	
	COM_DEFS += __BIRD_YD__
endif

ifeq ($(strip $(HD8020_ACK_CHECK_ENABLE)),TRUE)
       COM_DEFS += HD8020_ACK_CHECK
endif
ifeq ($(strip $(SMART_SEAL_SUPPORT_ENABLE)),TRUE)
       COM_DEFS += SMART_SEAL_SUPPORT
endif

ifeq ($(strip $(MTK_CHARGING_SUPPORT)),TRUE)
       COM_DEFS += MTK_CHARGING
endif

ifeq ($(strip $(HD8020_GPS_SUPPORT_ENABLE)),TRUE)
       COM_DEFS += HD8020_GPS_SUPPORT
endif

ifeq ($(strip $(BIRD_UART3_SUPPORT_ENABLE)),TRUE)
       COM_DEFS += BIRD_UART3_SUPPORT
endif

ifeq ($(strip $(BIRD_UART2_SUPPORT_ENABLE)),TRUE)
       COM_DEFS += BIRD_UART2_SUPPORT
endif

ifeq ($(strip $(BIRD_ECU_SUPPORT_ENABLE)),TRUE)
       COM_DEFS += BIRD_ECU_SUPPORT
       COM_DEFS += BIRD_ECU_MMI_SUPPORT       
endif

ifeq ($(strip $(BIRD_BT_SUPPORT_ENABLE)),TRUE)
       COM_DEFS += BIRD_BT_SUPPORT     
endif

ifeq ($(strip $(BIRD_ACC_ENSUPPORT_ENABLE)),TRUE)
       COM_DEFS += BIRD_ACC_UNSUPPORT     
endif

ifeq ($(strip $(BIRD_CAN_ENABLE)),TRUE)
...
ifeq ($(strip $(BIRD_SOS_UNSUPPORT_ENABLE)),TRUE)
       COM_DEFS += BIRD_SOS_UNSUPPORT
endif

ifeq ($(strip $(BIRD_EXTERNEL_POWER_UNSUPPORT_ENABLE)),TRUE)
       COM_DEFS += BIRD_EXTERNEL_POWER_UNSUPPORT
endif
ifeq ($(strip $(DW06A_PCB_SUPPORT)),TRUE)
       COM_DEFS += DW06A_PCB
endif

ifeq ($(strip $(DW21_PCB_SUPPORT)),TRUE)
       COM_DEFS += DW21_PCB
endif

ifeq ($(strip $(DW23_PCB_SUPPORT)),TRUE)
       COM_DEFS += DW23_PCB
endif

ifeq ($(strip $(MS_EINT_SUPPORT_ENABLE)),TRUE)
       COM_DEFS += MS_EINT_SUPPORT
endif

ifeq ($(strip $(UART_WAKE_SUPPORT_ENABLE)),TRUE)
       COM_DEFS += UART_WAKE_SUPPORT
endif
  COMPLIST    += bird
  COMMINCDIRS   +=  bird\base\inc
  COMMINCDIRS   +=  bird\yd\inc
  CUS_REL_BASE_COMP += bird\base\inc
  CUS_REL_BASE_COMP += bird\yd\inc
ifeq ($(strip $(BIRD_YD_CTA)),TRUE)

	#for CTA
	COM_DEFS += __BIRD_YD_CTA__


endif
ifeq ($(strip $(BIRD_AZ_ALARM_SUPPORT)),TRUE)
	COM_DEFS += BIRD_AZ_ALARM
endif
ifeq ($(strip $(BIRD_SWZ_DZ)),TRUE)
	COM_DEFS += BIRD_SWZ
endif
ifeq ($(strip $(BIRD_OC_LOGIC_SUPPORT)),TRUE)
	COM_DEFS += BIRD_OC_LOGIC
endif
ifeq ($(strip $(BIRD_DW06A_SUPPORT)),TRUE)
	COM_DEFS += __BIRD_DW06A__
endif
ifeq ($(strip $(BIRD_DW21_SUPPORT)),TRUE)
	COM_DEFS += __BIRD_DW21__
endif
ifeq ($(strip $(BIRD_DW22_SUPPORT)),TRUE)
	COM_DEFS += __BIRD_DW22__
endif
ifeq ($(strip $(BIRD_DW011OTA_SUPPORT)),TRUE)
	COM_DEFS += __BIRD_DW11__
endif
ifeq ($(strip $(BIRD_DW23_SUPPORT)),TRUE)
	COM_DEFS += __BIRD_DW23__
endif
ifeq ($(strip $(BIRD_DW60_SUPPORT)),TRUE)
	COM_DEFS += BIRD_DW60
endif
ifeq ($(strip $(BIRD_RUN_EINT_SUPPORT)),TRUE)
       COM_DEFS += __BIRD_RUN_EINT__
endif
ifeq ($(strip $(BIRD_DW18_SUPPORT)),TRUE)
	COM_DEFS += __BIRD_DW18__
endif

ifeq ($(strip $(BIRD_VEHICLE_SOUND_SUPPORT)),TRUE)
	COM_DEFS += __BIRD_VEHICLE_SOUND__
endif

ifeq ($(strip $(BIRD_LED_IDENTIFY_WINK_SUPPORT)),TRUE)
	COM_DEFS += __BIRD_LED_IDENTIFY_WINK__
endif
