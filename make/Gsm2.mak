     ...
     ifneq ($(words $(FOLDERLIST)),0)
       ...
       ifneq ($(strip $(TEMP2)),)
         ...
         ifneq ($(strip $(PERMISSON_ERROR_PATH)),)
           ...
           $(shell perl -e "print \"1.If NOT, please remove them from the COMMINCDIRS/COMPOBJS in the makefile.\".\"\n\" ;">> $(strip $(TARGDIR))/GlobalIncCheck.log)
