...
ifneq ($(filter __MMI_LANG_ZAWGYI_MYANMAR__, $(strip $(MODULE_DEFS))),)
           SRC_LIST += plutommi\Framework\Languages\Mynammar\MynammarSrc\Zawgyi.c
endif
...
ifneq ($(filter  __KARAOKE_SUPPORT__ __MMI_MEGAPHONE_SUPPORT__ __MMI_BTD_BOX_UI_STYLE__, $(strip $(MODULE_DEFS))),)
    SRC_LIST += plutommi\Framework\GUI\gui_src\wgui_categories_btbox.c
endif

ifneq ($(filter  __MMI_BTD_BOX_UI_STYLE__, $(strip $(MODULE_DEFS))),)
SRC_LIST += plutommi\Framework\GUI\gui_src\gui_picker.c \
			plutommi\Framework\GUI\gui_src\gui_dialer_pad.c
endif
