...
**************************************************************************** */
#define applib_dt_get_secure_time(t) applib_dt_get_rtc_time((applib_time_struct*)t)
...
extern void applib_dt_utc_to_rtc_with_default_tz(applib_time_struct *utc, applib_time_struct *result);
extern void applib_dt_rtc_to_utc_with_default_tz(applib_time_struct *rtc, applib_time_struct *result);
...
extern kal_uint8 bird_applib_dt_get_rtc_time(applib_time_struct *t);
...
extern DCL_RTC_DATA_T applib_dt_conv_utc_to_local(float tz, DCL_RTC_DATA_T *utc_time);
extern kal_uint32 app_getcurrtime(void);
extern kal_uint32 app_gettime(kal_uint32 *t_loc);
extern kal_bool applib_dt_check_valid_by_app(kal_uint16 min_year, kal_uint16 max_year, applib_time_struct *t);
