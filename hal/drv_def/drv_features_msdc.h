...
#if 1//defined(__MSDC_4BIT_BUSWIDTH__)
#define MSDC_SD_BITS4_BUS		// using 4bits bus width for SD card which has this feature
#endif


#define DCL_MSDC_INTERFACE
#if !(defined(__MSDC_SD_MMC__)||defined(__MSDC2_SD_MMC__)||defined(__MSDC_SD_SDIO__)||defined(__MSDC2_SD_SDIO__))
#define DRV_MSDC_OFF
#endif
