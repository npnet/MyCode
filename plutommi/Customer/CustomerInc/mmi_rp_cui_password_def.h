...
typedef enum
{
    STR_ID_CUI_PWD_DIFFERENT_INPUT = 33496 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    SCR_ID_CUI_PWD_BASIC = 33496 + 1, /* BASE_ID + 1 */
...
typedef enum 
{
    ...
    MMI_RP_CUI_PASSWORD_VXML_LAYOUT_MAX
} mmi_rp_cui_password_vxml_layout_enum;
