...
typedef enum
{
    MENU_ID_NETSET_MAIN = 40302 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    STR_ID_NETSET_NETWORK_SELECTION = 40302 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    GRP_ID_NETSET_MAIN = 40302 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    IMG_SETTING_NETWORK = 40302 + 1, /* BASE_ID + 1 */
