...
typedef enum
{
    MENU_ID_UCM_BT_INCALL_OPTION = 44218 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    STR_ID_UCM_BT_CALLING = 44218 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    GRP_ID_UCM_BT_PRE_MO = 44218 + 1, /* BASE_ID + 1 */
    GRP_ID_UCM_BT_MO,
    GRP_ID_UCM_BT_MT,
...
typedef enum
{
    UCM_NOTIFY_DURATION_TIMER_BT = 44218 + 1, /* BASE_ID + 1 */
