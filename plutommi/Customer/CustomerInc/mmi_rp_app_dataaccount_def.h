...
typedef enum
{
    MENU_ID_DTCNT_SIM_1 = 37229 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    STR_ID_DTCNT_RENAME = 37229 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    GRP_ID_DTCNT = 37229 + 1, /* BASE_ID + 1 */
    GRP_ID_DTCNT_PROV,
...
typedef enum
{
    SERVICES_DATA_CONNECT_IMAGE_ID = 37229 + 1, /* BASE_ID + 1 */
