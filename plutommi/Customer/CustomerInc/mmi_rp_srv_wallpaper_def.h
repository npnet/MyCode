...
typedef enum
{
    MENU_SETTING_WALLPAPER = 38861 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    STR_WALLPAPER_SYSTEM = 38861 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    SCR_MAIN_WALLPAPER = 38861 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    NVRAM_DISPCHAR_AVATAR_WPSS = 38861 + 1, /* BASE_ID + 1 */   /*       DOUBLE */ 
