...
typedef enum
{
    MAIN_MENU_FILE_MNGR_MENUID = 46018 + 1, /* BASE_ID + 1 */
    ...
    IDLE_SCREEN_MENU_ID,
    MENU_ID_MAIN_MENU_OPTIONS_OPEN,
    MENU_ID_MAIN_MENU_OPTIONS_UNINSTALLED,
...
typedef enum
{
    MAIN_MENU_TITLE_TEXT = 46018 + 1, /* BASE_ID + 1 */
    MAIN_MENU_MENU_TEXT,
    ...
    STR_ID_MAIN_MENU_UNINSTALL_ASK,
    STR_ID_MAIN_MENU_UNINSTALL,
    STR_ID_MAIN_MENU_EXIT_RUNNING_APP,
...
typedef enum
{
    MAIN_MENU_SCREENID = 46018 + 1, /* BASE_ID + 1 */
    SCR_ID_FILE_MANAGER,
    SCR_ID_MMEDIA,
    SCR_ID_CAMERA,
    SCR_ID_MAINMENU_OPTIONS_MENU,
...
typedef enum
{
    MAIN_MENU_TITLE_ICON = 46018 + 1, /* BASE_ID + 1 */
