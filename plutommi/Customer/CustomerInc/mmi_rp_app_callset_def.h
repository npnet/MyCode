...
typedef enum
{
    MENU_ID_CALLSET_CALL_CENTER = 36703 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    STR_ID_CALLSET_CALL_CENTER = 36703 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    GRP_ID_CALLSET_COMMON = 36703 + 1, /* BASE_ID + 1 */
    GRP_ID_CALLSET_CF,
    GRP_ID_CALLSET_CB,
    GRP_ID_CALLSET_CTR,
...
typedef enum
{
    IMG_ID_CALLSET_CALL_SETTING = 36703 + 1, /* BASE_ID + 1 */
