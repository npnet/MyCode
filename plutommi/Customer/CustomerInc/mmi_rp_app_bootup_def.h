...
typedef enum
{
    STR_ID_BOOTUP_NAND_NOT_SUPPORTED = 33030 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    GRP_ID_BOOTUP = 33030 + 1, /* BASE_ID + 1 */
    SCR_ID_BOOTUP_BASE,
...
typedef enum
{
    BOOTUP_WAITING_EVENT_TIMER = 33030 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    NVRAM_POWER_ON_DISPLAY_SUCCESS = 33030 + 1, /* BASE_ID + 1 */     /*        SHORT */ 
