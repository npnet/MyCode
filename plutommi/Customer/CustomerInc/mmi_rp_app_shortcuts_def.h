...
typedef enum
{
    EXTRA_SHORTCUTS_OPTION_ADD_MENUID = 41175 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    SHORTCUTS_TITLE_STRING_ID = 41175 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    GRP_ID_SHCT_QUICK_MENU_CFG = 41175 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    IMG_ID_SHORTCUTS_MAINMENU = 41175 + 1, /* BASE_ID + 1 */
