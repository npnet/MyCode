...
typedef enum
{
    STR_USB_CONFIG_TITLE = 46370 + 1, /* BASE_ID + 1 */
    STR_USB_CONFIG_MS,
...
typedef enum
{
    GRP_ID_USB_BOOT_MODE = 46370 + 1, /* BASE_ID + 1 */
    GRP_ID_USB_MMI,
    SCR_DEV_USBDETECT,
    SCR_USB_POWER_ON,
    SCR_USB_CHGR_CMPLT,
...
typedef enum
{
    USB_WAIT_FOR_MASS_STORAGE = 46370 + 1, /* BASE_ID + 1 */
...
typedef enum 
{
    ...
    MMI_RP_APP_USBMMI_VXML_LAYOUT_MAX
} mmi_rp_app_usbmmi_vxml_layout_enum;
