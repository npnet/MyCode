...
typedef enum
{
    MENU_ID_FMGR_DRIVE_OPTIONS = 38358 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    STR_FMGR_TITLE = 38358 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    FMGR_AUDIO_TIMER = 38358 + 1, /* BASE_ID + 1 */
    FMGR_SCR_TIMER,
...
typedef enum
{
    IMG_ID_FMGR_MAIN_MENUICON = 38358 + 1, /* BASE_ID + 1 */
    IMG_ID_FMGR_DRIVE_SPACE_0,
