...
typedef enum
{
    MENU_ID_EDITOR_OPT_INPUT_METHOD = 25842 + 1, /* BASE_ID + 1 */
    MENU_ID_EDIT_OPTS,
...
typedef enum
{
    STR_INPUT_METHOD_MENU_INSERT_SYMBOLS = 25842 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    GRP_ID_PHNSET_HANDWRITING = 25842 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    NVRAM_IME_SMART_MODE_CONFIG = 25842 + 1, /* BASE_ID + 1 */   /*         BYTE */ 
...
typedef enum
{
    IMG_ID_IME_VK_CHANGE_MODE = 25842 + 1, /* BASE_ID + 1 */
