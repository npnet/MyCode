...
typedef enum
{
    STR_ID_SIM_CTRL_SIM_ACCESS_ERROR = 33252 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    GRP_ID_SIM_CTRL = 33252 + 1, /* BASE_ID + 1 */
...
typedef enum 
{
    ...
    MMI_RP_APP_SIM_CTRL_VXML_LAYOUT_MAX
} mmi_rp_app_sim_ctrl_vxml_layout_enum;
