...
typedef enum
{
    MENU_ID_SMS_VM_VMAIL_MENUID = 44462 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    STR_ID_SMS_VM_VMAIL_MENUENTRY = 44462 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    SCR_ID_MSG_DELIVER_REPORT = 44462 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    MESSAGES_SUBLCD_TIMER_ID = 44462 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    IMG_SMS_VMAIL_MENUENTRY = 44462 + 1, /* BASE_ID + 1 */
