...
typedef enum
{
    MENU_ID_VOBJ_FMGR_SEND_SMS = 43410 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    STR_ID_VOBJ_RECEIVE_FALL = 43410 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    SCR_ID_VOBJ_RECV_OBJECT = 43410 + 1, /* BASE_ID + 1 */
    GRP_ID_VOBJ_BEGIN,
...
typedef enum 
{
    ...
    MMI_RP_SRV_VOBJECT_VXML_LAYOUT_MAX
} mmi_rp_srv_vobject_vxml_layout_enum;
