...
<APP id="SRV_PHB">
    ...
    <!-----------------------------------------------------Image Resource Area------------------------------------------------------>
# 225 "temp/res/PhbSrv.c"
    <IMAGE id="IMG_PHB_DEFAULT">"..\\\\..\\\\Customer\\\\Images\\\\PLUTO240X320""\\\\MainLCD\\\\Call\\\\Connect\\\\CL_NET.png"</IMAGE>
...
# 321 "temp/res/PhbSrv.c"
                        <OPTION hint="All"> [0x06, 0x00] </OPTION>
# 341 "temp/res/PhbSrv.c"
        </FIELD>
    </CACHEDATA>
