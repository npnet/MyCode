...
# 149 "temp/res/editor.c"
    <STRING id="STR_ID_INPUT_MODE_PINYIN"/>
    <STRING id="STR_ID_INPUT_MODE_BIHUA"/>
# 162 "temp/res/editor.c"
        <SCREEN id = "GRP_ID_PHNSET_HANDWRITING"/>

    <!-----------------------------------------------------Image Resource Area------------------------------------------------------>
# 176 "temp/res/editor.c"
        <IMAGE id="IMG_ID_IME_VK_CHANGE_MODE" >"..\\\\..\\\\Customer\\\\Images\\\\PLUTO240X320""\\\\MainLCD\\\\UIElement\\\\VK3\\\\PopupList_ChangeMode.png"</IMAGE>
        <IMAGE id="IMG_ID_IME_VK_CHANGE_SETTING" >"..\\\\..\\\\Customer\\\\Images\\\\PLUTO240X320""\\\\MainLCD\\\\UIElement\\\\VK3\\\\PopupList_Setting.png"</IMAGE>

    <!------------------------------------------------------Menu Resource Area------------------------------------------------------>
# 358 "temp/res/editor.c"
            <MENUITEM id="MENU_ID_EDITOR_OPT_INPUT_METHOD" str="STR_GLOBAL_INPUT_METHOD" group="MENU_GROUP_EDITOR"/>
# 416 "temp/res/editor.c"
