...
typedef enum
{
    MENU_ID_SECSET_MAIN_MENU = 33324 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    STR_ID_SECSET_APP_NAME = 33324 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    GRP_ID_SECSET = 33324 + 1, /* BASE_ID + 1 */
...
typedef enum 
{
    ...
    MMI_RP_APP_SECURITY_SETTING_VXML_LAYOUT_MAX
} mmi_rp_app_security_setting_vxml_layout_enum;
...
typedef enum
{
    IMG_SECSET_MENU_ENTRY = 33324 + 1, /* BASE_ID + 1 */
