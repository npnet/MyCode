...
typedef enum
{
    MENU_SETTING_FLIGHT_MODE = 39164 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    STR_MENU_FLIGHT_MODE = 39164 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    SCR_FLIGHT_MODE_PROGRESS = 39164 + 1, /* BASE_ID + 1 */
...
typedef enum 
{
    ...
    MMI_RP_SRV_FLIGHT_MODE_VXML_LAYOUT_MAX
} mmi_rp_srv_flight_mode_vxml_layout_enum;
