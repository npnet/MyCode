...
typedef enum
{
    MENU_ID_UCM_OUTGOING_OPTION = 44017 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    STR_ID_UCM_DIALER = 44017 + 1, /* BASE_ID + 1 */
    STR_ID_UCM_CALLING,
...
typedef enum
{
    GRP_ID_UCM_PRE_MO = 44017 + 1, /* BASE_ID + 1 */
    GRP_ID_UCM_MO,
    GRP_ID_UCM_MT,
    GRP_ID_UCM_INCALL,
    GRP_ID_UCM_VT,
...
typedef enum
{
    UCM_NOTIFY_DURATION_TIMER = 44017 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    IMG_ID_UCM_CALL_STATE_ACTIVE = 44017 + 1, /* BASE_ID + 1 */
