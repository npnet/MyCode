...
typedef enum
{
    MAIN_MENU_ORGANIZER_NO_SIM_MENUID = 42412 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    ORGANIZER_SCREENID = 42412 + 1, /* BASE_ID + 1 */
    GRP_ID_ORG,
...
typedef enum 
{
    ...
    MMI_RP_APP_ORGANIZER_VXML_LAYOUT_MAX
} mmi_rp_app_organizer_vxml_layout_enum;
...
typedef enum
{
    ORGANIZER_TITLE_IMAGEID = 42412 + 1, /* BASE_ID + 1 */
