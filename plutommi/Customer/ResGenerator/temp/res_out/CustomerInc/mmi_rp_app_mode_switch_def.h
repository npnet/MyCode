...
typedef enum
{
    STR_ID_MODE_SWITCH_SWITCHING = 40503 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    SCR_ID_MODE_SWITCH_START = 40503 + 1, /* BASE_ID + 1 */
...
typedef enum 
{
    ...
    MMI_RP_APP_MODE_SWITCH_VXML_LAYOUT_MAX
} mmi_rp_app_mode_switch_vxml_layout_enum;
