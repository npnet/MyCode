...
typedef enum
{
    ORGANIZER_ALARM_MENU = 42218 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    ALARMS_SNOOZE_STRINGID = 42218 + 1, /* BASE_ID + 1 */
    ALARM_REPEAT_STRING,
    ALARM_ONCE_STRING,
    ALARM_HOURLY_STRING,
...
typedef enum
{
    SCR_ID_ALM_LIST = 42218 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    ALARM_ALERT_NOTIFYDURATION_TIMER = 42218 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    ALARMS_EDIT_SOFTKEY_IMAGEID = 42218 + 1, /* BASE_ID + 1 */
    ALARM_ANIMATION_INDICATION_IMAGEID,
    MAIN_MENU_ALARM_ICON,
