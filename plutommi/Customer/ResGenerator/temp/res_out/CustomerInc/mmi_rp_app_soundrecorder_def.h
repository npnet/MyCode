...
typedef enum
{
    MENU_ID_SNDREC_MAIN = 34471 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    STR_ID_SNDREC_MAIN = 34471 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    GRP_ID_SNDREC_START_BASE = 34471 + 1, /* BASE_ID + 1 */
    GRP_ID_SNDREC_MAIN,
...
typedef enum
{
    SNDREC_TIMER_FILELIST_SEEK = 34471 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    NVRAM_AUTO_VM_SETTING_VM_SUPPORT = 34471 + 1, /* BASE_ID + 1 */       /*         BYTE */ 
...
typedef enum
{
    IMG_ID_SNDREC_VUI_MAIN_MENU_APP_ICON = 34471 + 1, /* BASE_ID + 1 */
