...
typedef enum
{
    MENU_ID_FM_ROOT = 13419 + 1, /* BASE_ID + 1 */
    MENU_ID_FM_ADC,
    MENU_ID_FM_RTC,
...
typedef enum
{
    STR_ID_FM_ROOT = 13419 + 1, /* BASE_ID + 1 */
    STR_ID_FM_VERSION,
...
typedef enum
{
    SCR_ID_FM_MISC_AUTO_TEST_SETTING = 13419 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    FM_LCD_COLOR_CHANGE_TIMER = 13419 + 1, /* BASE_ID + 1 */
