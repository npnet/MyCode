...
typedef enum
{
    STR_ID_AUDPLY_TITLE = 34772 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    SCR_ID_AUDPLY_BASE = 34772 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    AUDPLY_PROCESS_ADD_FILE_TIMER = 34772 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    NVRAM_AUDPLY_SINGLE_VOL = 34772 + 1, /* BASE_ID + 1 */      /*         BYTE */ 
...
typedef enum
{
    IMG_ID_AUDPLY_PLAY_ANIMATION = 34772 + 1, /* BASE_ID + 1 */
