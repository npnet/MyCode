...
typedef enum
{
    MENU_ID_PROF_GENERAL = 38127 + 1, /* BASE_ID + 1 */
    MENU_ID_PROF_SILENT,
...
typedef enum
{
    STR_ID_PROF_CAPTION = 38127 + 1, /* BASE_ID + 1 */
    STR_ID_PROF_GENERAL,
    STR_ID_PROF_SILENT,
    STR_ID_PROF_MEETING,
    STR_ID_PROF_OUTDOOR,
...
typedef enum
{
    GRP_ID_PROFILES = 38127 + 1, /* BASE_ID + 1 */
    SCR_KEY_TONE_VOLUME,
...
typedef enum
{
    TIMER_PROFILES_TONE_PLAY = 38127 + 1, /* BASE_ID + 1 */
    KEY_VOL_TIMER_ID,
...
typedef enum
{
    MAIN_MENU_USER_PROFILES_ICON = 38127 + 1, /* BASE_ID + 1 */
