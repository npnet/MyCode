...
typedef enum
{
    MENU_ID_IMGVIEW_APP = 34128 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    STR_ID_IMGVIEW_NAME = 34128 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    SCR_ID_IMGVIEW_VIEW = 34128 + 1, /* BASE_ID + 1 */
...
typedef enum
{
    NVRAM_IMGVIEW_VIEW_SYTLE = 34128 + 1, /* BASE_ID + 1 */     /*         BYTE */ 
...
typedef enum
{
    IMG_ID_IMGVIEW_MAIN_ICON = 34128 + 1, /* BASE_ID + 1 */
    IMG_ID_IMGVIEW_VUI_MAIN_MENU_APP_ICON,
    IMG_ID_IV_ERROR,
    IMG_ID_IV_LOAD,
