...
//lqy
void DW02_SWITCH_TO_FLIGHT(MMI_BOOL  is_switch)
{         
   	 if(is_switch)
	    {
	...
	else
	{
       ...
       kal_prompt_trace(  MOD_SOC,"[DW02_SWITCH_TO_FLIGHT] g_flight_mode_select_mode,g_flight_mode_current_mode %d,%d",g_flight_mode_select_mode,g_flight_mode_current_mode);
