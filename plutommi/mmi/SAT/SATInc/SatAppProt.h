...
extern MMI_BOOL mmi_sat_open_channel_response(mmi_sat_group_data_struct *group_data, mmi_sat_response_enum res_type);
...
extern MMI_BOOL mmi_sat_close_channel_response(mmi_sat_group_data_struct *group_data, mmi_sat_response_enum res_type);
#endif
...
extern MMI_BOOL mmi_sat_send_data_response(mmi_sat_group_data_struct *group_data, mmi_sat_response_enum res_type);
...
extern MMI_BOOL mmi_sat_recv_data_response(mmi_sat_group_data_struct *group_data, mmi_sat_response_enum res_type);
#endif  /* __SATCE__ */
